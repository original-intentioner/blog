...
public class PageUtil {
	/*<li><a href='/index.html?page=1&'>首页</a>
	    </li>
	 ...
	 * 翻页方法
	 */
	public static String getPagination(String targetUrl,int currentPage,long totalNum,int pageSize,String param) {
		//总共页数
		if(totalNum == 0) {
			return "未查询到数据";
		}
