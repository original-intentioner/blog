...
<script type="text/javascript">
	...
	function formatTitle(val,row){
		return "<a target='_blank' href='${pageContent.request.contextPath}/Blog/blog/articles/"+row.id+".html'>"+val+"</a>";
	}
	/**返回该行的博客类型名称*/
...
<table id="dg" title="博客管理" class="easyui-datagrid" fitcolumns="true" 
	pagination="true" rownumber="true" fit="true" toolbar="#tb"
	...
	<thead>
		<tr>
			...
			<th field="releaseDate" width="20" align="center">发布日期</th>
